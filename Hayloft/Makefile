...
COM_DIAG_HAYLOFT_LOGGER_MASK_DEBUG=0xfff0
...
debug:	unittest
	export COM_DIAG_HAYLOFT_LOGGER_MASK="$(COM_DIAG_HAYLOFT_LOGGER_MASK_DEBUG)"; \
...
exercise:	unittest
	...
	export COM_DIAG_HAYLOFT_LIBS3_CURL_LOW_SPEED_TIME="$(COM_DIAG_HAYLOFT_LIBS3_CURL_LOW_SPEED_TIME)"; \
	export LD_LIBRARY_PATH=$(HAYLOFT_LIBS):$(DESPERADO_LIBS):$(S3_LIBS); \
	script -c "time ./unittest --gtest_color=no --gtest_filter=$(FILTER)" exercise.log # e.g. FILTER=BucketFilter.Explicit
