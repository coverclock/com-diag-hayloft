...
#include "com/diag/hayloft/release.h"

const char COM_DIAG_HAYLOFT_RELEASE_KEYWORD[] = "COM_DIAG_HAYLOFT_RELEASE=" COM_DIAG_HAYLOFT_RELEASE;
const char * COM_DIAG_HAYLOFT_RELEASE_VALUE = &COM_DIAG_HAYLOFT_RELEASE_KEYWORD[sizeof("COM_DIAG_HAYLOFT_RELEASE=") - 1];
