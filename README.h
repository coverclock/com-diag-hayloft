...
--------------------------------------------------------------------------------
	...
	use macros or inline functions from this package, or you compile
	this package and link it with other works to produce a work based on
	this package, this file does not by itself cause the resulting work
	to be covered by the GNU Lesser General Public License. However
	the source code for this package must still be made available in
